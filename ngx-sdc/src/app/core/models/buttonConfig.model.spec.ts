...
describe(`ButtonConfig`, () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [{provide: ButtonConfig, useFactory: (test1: string, test2: string, test3: TypeButton) => {
                return new ButtonConfig(test1, test2, test3);
              },}]
        });
    ...
    it('should throw exception when onClick is called', () => {
        expect( function(){ model.onClick(''); } ).toThrow(new Error('Method not allowed'));
    });
});
