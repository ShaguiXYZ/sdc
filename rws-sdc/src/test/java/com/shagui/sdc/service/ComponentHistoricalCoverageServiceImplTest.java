...
class ComponentHistoricalCoverageServiceImplTest {
	...
	void constructorTest() {
		...
		ComponentHistoricalCoverageServiceImpl constructor = new ComponentHistoricalCoverageServiceImpl(
				componentRepository, componentHistoricalCoverageRepository);
	...
	void historicalCoverageTest() {
		...
		when(componentHistoricalCoverageRepository.findById_ComponentIdOrderById_AnalysisDateAsc(anyInt()))
				.thenReturn(list);
	...
	void historicalCoverage2Test() {
		...
		when(componentHistoricalCoverageRepository.findById_ComponentIdOrderById_AnalysisDateAsc(anyInt(),
				nullable(Pageable.class))).thenReturn(page);
