...
public interface ComponentAnalysisRepository extends JpaRepository<ComponentAnalysisModel, ComponentAnalysisPk> {
    ...
    Optional<ComponentAnalysisModel> analysisValueByDate(int componentId, int metricId, Timestamp date);
    ...
    @Query("""
            ...
            """)
    List<ComponentAnalysisModel> historyOfMetricByDate(int componentId, int metricId, Timestamp date);
    ...
    @Query("""
            SELECT ca FROM ComponentAnalysisModel ca
             ...
             ORDER BY ca.id.analysisDate ASC
            """)
    Page<ComponentAnalysisModel> metricHistory(int componentId, int metricId, Timestamp date, Pageable pageable);
